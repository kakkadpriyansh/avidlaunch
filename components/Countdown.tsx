...
export default function Countdown() {
  ...
  useEffect(() => {
    ...
    // Calculate target date (22nd of next month)
    const calculateTargetDate = () => {
      const now = new Date()
      const currentMonth = now.getMonth()
      const currentYear = now.getFullYear()

      // If we're past the 22nd of current month, target next month
      // Otherwise target this month
      ...
      return new Date(targetYear, targetMonth, 22, 0, 0, 0)
    }
